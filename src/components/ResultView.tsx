    ...
    <div className="w-full mt-4 flex flex-col items-center animate-fade-in space-y-4">
      ...
      <div className="w-full bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4 sm:p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <a
            href={`https://www.google.com/search?q=${encodeURIComponent(`catalogo oficial ${result.vehicle} ${result.year || ''} ${result.part} nakata cobreq luk sachs bosch fras-le cofap`)}`}
            target="_blank"
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 self-end sm:self-center shrink-0 flex-wrap">
                              ...
                              <a
                                href={`https://www.google.com/search?q=${encodeURIComponent(`catalogo oficial ${item.brand} ${item.code} aplicacao ${result.vehicle} ${result.year || ''}`)}`}
                                target="_blank"
                                rel="noopener noreferrer"
